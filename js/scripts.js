...
const producto3 = new Planta("Planta cebra", "$300", "plantaCebra")
const producto4 = new Planta("Aeonium Kiwi", "$200 - $400", "aeoniumKiwi")
...
const producto11 = new Planta("Cubremacetas1", "$250", "desconocida2")
const producto12 = new Planta("  -  ", "$200", "desconocida3")
const producto13 = new Planta("Cubremacetas2", "$300", "desconocida4")
const producto14 = new Planta("Cubremacetas4", "$350", "desconocida5")
const producto15 = new Planta("Aeonium Haworthii - Grande", "$500", "aeoniumHaworthii2")
const producto16 = new Planta("Cactus", "$280", "cactus1")
const producto17 = new Planta("Cactus", "$280", "cactus2")
...
const productos = [producto1, producto2, producto3, producto4, producto5, producto7, producto8, producto9, producto11, producto12,producto13, producto14,producto15, producto16, producto17]
